...
public class SplittedStringConverter {
    ...
    private final FluxChatPlayer.PlaceholderResolver resolver;
     ...
     * @since    3.2.0
     */
    public SplittedStringConverter(SplittedStringList list, FluxChatPlayer.PlaceholderResolver resolver) {
        this.list = list;
